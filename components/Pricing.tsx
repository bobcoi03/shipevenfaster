        ...
        <div className="max-w-6xl px-4 py-8 mx-auto sm:py-24 sm:px-6 lg:px-8">
          <div className="sm:flex sm:flex-col sm:align-center">
            ...
            <div className="relative flex self-center mt-12 border rounded-lg border-zinc-800">
              <div className="border border-opacity-50 divide-y rounded-lg shadow-sm divide-zinc-600">
            ...
            <div className="mt-6 space-y-4 sm:mt-12 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-6 lg:max-w-4xl lg:mx-auto xl:max-w-none xl:mx-0 xl:grid-cols-3">
              {products[0].prices?.map((price) => {
                ...
                return (
                  <div
                    key={price.interval}
                    className="divide-y rounded-lg shadow-sm divide-zinc-600 border"
                  >
                    <div className="p-6">
                      <p>
                      ...
                      <Button
                        ...
                        className="border w-full py-2 mt-12 text-sm font-semibold text-center rounded-md hover:bg-zinc-900 "
                      >
                        {products[0].name ===
              ...
              <button
                ...
                className={`${
                  billingInterval === 'month'
                    ? 'relative w-1/2 border-zinc-800 shadow-sm'
          ...
          {products.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className={cn(
                  'rounded-lg shadow-sm divide-y divide-zinc-600 border-zinc-800 border',
                  {
              ...
              >
                <div className="p-6">
                  ...
                  <Button
                    ...
                    className="w-full py-2 mt-8 text-sm font-semibold text-center rounded-md border-gray-600 border"
                  >
